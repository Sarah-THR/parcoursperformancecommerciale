...
namespace EcoleDeLaPerformance.API.Infrastructure.Migrations
{
    ...
    [Migration("20250806143251_AddFavoritesAgency")]
    partial class AddFavoritesAgency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoleDeLaPerformance.API.Core.Domain.Entities.FavoritesAgency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__favorites_agencies__3213E83F971B5BFD");

                    b.HasIndex("UserId");

                    b.ToTable("favorites_agencies", (string)null);
                });
            ...
            modelBuilder.Entity("EcoleDeLaPerformance.API.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool?>("IsFirstConnection")
                        .HasColumnType("bit")
                        .HasColumnName("is_first_connection");
            ...
            modelBuilder.Entity("EcoleDeLaPerformance.API.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("FavoritesAgencies");
